...
if(isset($_POST['nama_pem'])){
    ...
    LEFT JOIN APPS.PER_GRADES PVG ON PAF.GRADE_ID = PVG.GRADE_ID
	...
	// LEFT JOIN APPS.PER_VALID_GRADES_V PVG ON PVG.POSITION_ID=PP.POSITION_ID AND PAF.GRADE_ID = PVG.GRADE_ID
