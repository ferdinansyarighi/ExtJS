...
if($countChecker == 0){
	...
	if($tingkat == 2){
		...
		, BS.NOMINAL
		, BS.KETERANGAN
		, BS.TIPE, HOU2.NAME, TO_CHAR(BS.TGL_JT, 'DD-MON-YYYY')
		FROM MJ.MJ_T_BS BS
		...
		WHERE 1=1 AND BS.TINGKAT = 2 and BS.PERUSAHAAN_BS not in (SELECT PERUSAHAAN_ID FROM MJ.MJ_M_APPROVAL_PINJAMAN WHERE TIPE = 'BS' AND STATUS = 'A' AND CHECKER_ID is not null)
		$queryfilter";
	}
	...
	BS.PERUSAHAAN_BS in (SELECT PERUSAHAAN_ID FROM MJ.MJ_M_APPROVAL_PINJAMAN WHERE TIPE = 'BS' AND STATUS = 'A' AND CHECKER_ID is not null AND CHECKER_ID = $emp_id) or BS.PERUSAHAAN_BS not in (SELECT PERUSAHAAN_ID FROM MJ.MJ_M_APPROVAL_PINJAMAN WHERE TIPE = 'BS' AND STATUS = 'A' AND CHECKER_ID is not null)) $queryfilter";
}
//echo $query;exit;
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
if($countAcc == 0){
	...
	if($query != ''){
		...
		BS.PERUSAHAAN_BS in (SELECT PERUSAHAAN_ID FROM MJ.MJ_M_APPROVAL_PINJAMAN WHERE TIPE = 'BS' AND STATUS = 'A' AND ACCOUNTING_ID is not null AND ACCOUNTING_ID = $emp_id) or BS.PERUSAHAAN_BS not in (SELECT PERUSAHAAN_ID FROM MJ.MJ_M_APPROVAL_PINJAMAN WHERE TIPE = 'BS' AND STATUS = 'A' AND ACCOUNTING_ID is not null)) 
		$queryfilter
		";
	}else{
		$query = "SELECT BS.ID, BS.NO_BS, PPF.FULL_NAME PEMOHON, HOU.NAME PERUSAHAAN
