...
//$hrd_id
	...
	*/
	...
	$pdf->SetFont('Arial', 'B', 7);	
	$pdf->Cell(60, 10, 'Rp. '.number_format($nominal, 2, ',', '.'), 1, 0, 'L', 0);
	$pdf->SetFont('Arial', '', 7);
	...
	//$pdf->Cell(60, 10, $pdf->Row('Terbilang : '.terbilang($jumlah_pinjaman)), 'LTR', 0, 'L', 0);
	$terbilang = terbilang($nominal);
	if(strlen($terbilang) > 38){
		$terbilang1 = substr($terbilang,0,38).'-';
		$terbilang2 = substr($terbilang,38);
	}else{
		$terbilang1 = $terbilang;
		$terbilang2 = '';
	} 
	$pdf->Cell(60, 10, 'Terbilang : '.$terbilang1, 'LR', 0, 'L', 0);
	$pdf->SetFont('Arial', '', 7);
	$pdf->Cell(60, -9, '   a. _______________________________________________________', 0, 0, 'L', 0);
	$pdf->Cell(-37.5, -1.5, '   b. _______________________________________________________', 0, 0, 'C', 0);
	$pdf->Cell(37.5, 6.5, '   c. _______________________________________________________', 0, 0, 'C', 0);
	$pdf->Cell(-37.5, 14.5, '   d. _______________________________________________________', 0, 0, 'C', 0);
	$pdf->Cell(97.5, -4, '', 'R', 0, 'L', 0);
	$pdf->Cell(0.00000001, 10, '', 'R', 0, 'L', 0);
	$pdf->Ln(10);
	$pdf->Cell(8, 3, '', 0, 0, 'L', 0);	
	$pdf->Cell(60, 3, $terbilang2, 'LR', 0, 'C', 0);
	$pdf->Cell(120, 3, '   e. _______________________________________________________', 'LR', 0, 'L', 0);
	$pdf->Ln(3);
	$pdf->Cell(8, 3, '', 0, 0, 'L', 0);	
	$pdf->Cell(60, 3, '', 'LBR', 0, 'C', 0);
	$pdf->Cell(120, 3, '', 'LBR', 0, 'C', 0);
	$pdf->Ln(3);
	$pdf->Cell(8, 10, '', 0, 0, 'L', 0);	
	$pdf->SetFont('Arial', '', 7);
	...
	*/
	...
	$pdf->Cell(30, 8, 'Tgl :    '.$tgl_app_ckr, 'LR', 0, 'L', 0);
	$pdf->Cell(30, 8, 'Tgl :    ', 'LR', 0, 'L', 0);
	$pdf->Cell(30, 8, 'Tgl :    ', 'LR', 0, 'L', 0);
	$pdf->Cell(30, 8, 'Tgl :    '.$tglskr, 'LR', 0, 'L', 0);
	$pdf->Ln(8);
	...
	$pdf->Cell(30, 0, '', 'LR', 0, 'C', 0);	
	$pdf->SetFont('Arial', '', 5);
	$pdf->Cell(30, 4, '', 'LR', 0, 'C', 0);
	$pdf->Ln(0);
	$pdf->Cell(8, 4, '', 0, 0, 'L', 0);	
	$pdf->SetFont('Arial', '', 5);
	$pdf->Cell(30, 4, $pem, 'LRB', 0, 'C', 0);
	$pdf->Cell(30, 4, $pj, 'LRB', 0, 'C', 0);
	$pdf->Cell(30, 4, $nama_ckr, 'LRB', 0, 'C', 0);
	$pdf->Cell(30, 4, '', 'LRB', 0, 'L', 0);
	$pdf->Cell(30, 4, '', 'LRB', 0, 'L', 0);
	$pdf->Cell(30, 4, $hrd, 'LRB', 0, 'C', 0);
