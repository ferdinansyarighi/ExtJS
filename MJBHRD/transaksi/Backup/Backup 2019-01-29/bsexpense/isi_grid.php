...
//$hdid=$_GET['hd_id']; 
	$count=0;
	$result = oci_parse($con, "SELECT ID, BS_HD_ID, TIPE_EXPENSE, NOMINAL, TO_CHAR(TGL_EXPENSE, 'YYYY-MM-DD'), KETERANGAN, TO_CHAR(CREATED_DATE, 'YYYY-MM-DD') FROM MJ.MJ_T_BS_DT WHERE 1=1 $querywhere");
	oci_execute($result);
