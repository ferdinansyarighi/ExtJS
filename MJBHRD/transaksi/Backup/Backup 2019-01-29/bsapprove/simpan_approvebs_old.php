 ...
 if(isset($_POST['typeform']))
  {
	...
	// $arrTglJT=json_decode($_POST['arrTglJT']);
...
for ($x=0; $x<$countID; $x++){
	...
	if ($typeform=='Setuju') {		
		...
		$queryUpdate = "UPDATE MJ.MJ_T_BS SET TINGKAT=$tingkat, STATUS = '$Keputusan', LAST_UPDATED_BY='$emp_id', LAST_UPDATED_DATE=SYSDATE WHERE ID=$TransID";
