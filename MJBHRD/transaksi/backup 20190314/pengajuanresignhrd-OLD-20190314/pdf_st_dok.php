...
class myPdf extends pdfmctable
{
	...
	function Header()
	{
		...
		if($this->PageNo() == 1)
		{
			...
			$this->Cell(80, 25, "SERAH TERIMA PEKERJAAN / DOKUMEN" . '', 0, 0, 'L', 0);
			$this->Ln(25);
			...
			$this->Cell(70,6,'JENIS PEKERJAAN','LRT',0,'C',1);
			$this->Cell(40,6,'BENTUK','LRT',0,'C',1);
			$this->Cell(35,6,'STATUS','LRT',0,'C',1);
			...
			$this->Cell(40,6,'PENYIMPANAN','LRB',0,'C',1);
...
$pdf->Output('ST_Pekerjaan_'. "$hdidlagi" . '.pdf', 'F');
$pdf->Output();
?>
