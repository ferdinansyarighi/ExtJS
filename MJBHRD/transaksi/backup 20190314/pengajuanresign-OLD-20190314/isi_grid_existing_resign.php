...
BULAN_LAMA_KERJA, HARI_LAMA_KERJA, MANAGER, KETERANGAN, STATUS, APPROVAL_MANAGER, APPROVAL_MANAGER_HRD, TGL_APP_TERAKHIR, CREATED_BY,CREATED_DATE, TO_CHAR(TGL_PENGAJUAN, 'DD/MM/YY')
FROM MJ.MJ_T_RESIGN WHERE (CREATED_BY = $emp_id OR NAMA_KARYAWAN LIKE '$emp_name') AND STATUS = 1 AND VALIDASI IS NULL";
