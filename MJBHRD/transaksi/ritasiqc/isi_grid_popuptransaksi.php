...
{	
	...
	// }
	for($i=0; $i<=$selisih; $i++){
		$queryHariIni = "SELECT TO_CHAR((TO_DATE('$tglfrom', 'YYYY-MM-DD') + $i), 'DAY') FROM DUAL";
		...
		AND TO_CHAR(A.HOLIDAY_DATE, 'DD-MON-YYYY')=TO_CHAR((TO_DATE('$tglfrom', 'YYYY-MM-DD') + $i), 'DD-MON-YYYY')";
