	...
	if($typeform == "edit"){
		...
		if($countData == 0){
			...
			if($statusBS == 'Approved'){
				$sqlQuery = "UPDATE MJ.MJ_T_BS SET TINGKAT = 6, STATUS='Validated' ,TIPE_PENCAIRAN='$tipe', NO_REK='$no_rek', TGL_PENCAIRAN=to_date('$tgl','YYYY-MM-DD'), TGL_JT=to_date('$tgl_jt','YYYY-MM-DD') WHERE 1=1 AND ID=$hdid ";
