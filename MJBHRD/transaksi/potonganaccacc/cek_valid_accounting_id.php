 ...
 if(isset($_POST['hdid']))
  {
  	$hdid=$_POST['hdid'];
		...
		$QueryAccounting = oci_parse( $con, "
			...
			");
		oci_execute( $QueryAccounting );
		$rowAccounting = oci_fetch_row( $QueryAccounting );
		$accounting_id = $rowAccounting[0];
