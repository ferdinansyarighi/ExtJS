...
/*			$sqlQuery = "DELETE FROM MJ.MJ_TEMP_UPLOAD WHERE USERNAME='$user_id' AND TRANSAKSI_KODE='RESIGN' ";
			...
			$sqlString 	= "	INSERT INTO MJ.MJ_TEMP_UPLOAD(ID, APP_ID, TRANSAKSI_ID, FILENAME, FILESIZE, FILETYPE, USERNAME, CREATEDDATE, TRANSAKSI_KODE) 
							VALUES($id, " . APPCODE . ", '".$hd_id."', '".$file_name."', '".$arsipSize."', '".$arsipType."', '".$userid."', TO_DATE('$date1', 'YYYY-MM-DD'), 'RESIGN')";
							//echo $sqlString;
