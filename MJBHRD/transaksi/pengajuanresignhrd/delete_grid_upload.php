...
/*	$sqlQuery = "DELETE FROM MJ.MJ_M_UPLOAD WHERE USERNAME='$user_id' AND id=$idupload AND TRANSAKSI_KODE='RESIGN' ";
	//echo $sqlQuery;
	$result = oci_parse($con,$sqlQuery);
	oci_execute($result);*/

	//$sqlQueryB = "DELETE FROM MJ.MJ_TEMP_UPLOAD WHERE USERNAME='$user_id' AND id=$idupload AND TRANSAKSI_KODE='RESIGN' ";
	//echo $sqlQuery;
	$sqlQueryB = "DELETE FROM MJ.MJ_TEMP_UPLOAD WHERE id=$idupload AND TRANSAKSI_KODE='RESIGN' ";
	$resultB = oci_parse($con,$sqlQueryB);
	oci_execute($resultB);
