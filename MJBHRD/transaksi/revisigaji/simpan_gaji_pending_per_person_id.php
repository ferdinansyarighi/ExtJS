...
FROM MJ_M_GAJI WHERE BULAN='$bulan' AND TAHUN='$tahun' AND REVISI=$revisi and person_id = 1947";
//echo $queryJumHari;
...
if($vCekData >= 0){
	$queryCekData = "DELETE	FROM MJ_M_GAJI WHERE BULAN='$bulan' AND TAHUN='$tahun' AND REVISI=$revisi and person_id = 1947";
	//echo $queryJumHari;
	$resultCekData = oci_parse($con,$queryCekData);
	oci_execute($resultCekData);
}
