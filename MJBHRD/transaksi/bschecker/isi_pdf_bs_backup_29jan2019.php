...
SELECT DISTINCT NVL( PPF.MIDDLE_NAMES, BS.NAMA_EXTERNAL ), BS.NO_BS
    ...
    , TO_CHAR(BS.CREATED_DATE, 'DD-MON-YYYY HH:MI:SS')) TGL_APP_MGR
    , MTA2.CREATED_BY APP_CKR
    , NVL(to_char(MTA2.CREATED_DATE, 'DD-MON-YYYY HH:MI:SS')
    , TO_CHAR(BS.CREATED_DATE, 'DD-MON-YYYY HH:MI:SS')) TGL_APP_CKR
    , HOU2.NAME, TO_CHAR(BS.TGL_JT, 'DD - Mon - YYYY')
    , BS.SYARAT1, BS.SYARAT2, BS.SYARAT3, BS.SYARAT4, BS.SYARAT5
    , MTA3.CREATED_BY APP_HRD
    , NVL(to_char(MTA3.CREATED_DATE, 'DD-MON-YYYY HH:MI:SS'), TO_CHAR(BS.CREATED_DATE, 'DD-MON-YYYY HH:MI:SS')) TGL_APP_HRD
    , MTA4.CREATED_BY APP_CKR
    , NVL(to_char(MTA4.CREATED_DATE, 'DD-MON-YYYY HH:MI:SS'), TO_CHAR(BS.CREATED_DATE, 'DD-MON-YYYY HH:MI:SS')) TGL_APP_CKR
