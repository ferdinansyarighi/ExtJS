...
class myPdf extends pdfmctable
{
	...
	function Header()
	{
		...
		if($this->PageNo() == 1)
		{
			...
			$this->Cell(200, 8, 'SURAT KEPUTUSAN', 0, 0, 'C', 0);					
			$this->Ln(6);
...
$managerHRD = $rowHRD[0];
	...
	$pdf->Cell(200, 8, 'PROMOSI JABATAN KARYAWAN', 0, 0, 'C', 0);			
	$pdf->Ln(13);
	$pdf->SetFont('Arial', '', 8);
	$pdf->Cell(15, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(12, 5, 'Menunjuk :', 0, 0, 'L', 0);	
	$pdf->Cell(5, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(5, 5, '1.', 0, 0, 'L', 0);
	$pdf->Cell(130, 5, 'Pentingnya personil yang capabel di Plan ' . $xLokasi, 0, 0, 'L', 0);								
	$pdf->Ln(5);
	$pdf->Cell(15, 5, '', 0, 0, 'L', 0);	
	...
	$pdf->Ln(5);
	$pdf->Cell(15, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(12, 5, 'Menimbang :', 0, 0, 'L', 0);	
	$pdf->Cell(5, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(5, 5, '1.', 0, 0, 'L', 0);
	$pdf->Cell(130, 5, 'Peraturan Perusahaan di lingkungan PT. Merak Jaya Beton', 0, 0, 'L', 0);								
	$pdf->Ln(5);
	$pdf->Cell(15, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(12, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(5, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(5, 5, '2.', 0, 0, 'L', 0);
	$pdf->Cell(130, 5, 'Kelancaran opersional di plan ' . $xLokasi, 0, 0, 'L', 0);				
	$pdf->Ln(13);
	$pdf->Cell(200, 8, 'MEMUTUSKAN', 0, 0, 'C', 0);					
	$pdf->Ln(8);
	$pdf->Cell(15, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(5, 5, '1.', 0, 0, 'L', 0);	
	$pdf->Cell(20, 5, 'Nama ', 0, 0, 'L', 0);
	$pdf->Cell(5, 5, ':', 0, 0, 'L', 0);	
	$pdf->Cell(100, 5, $xKaryawan, 0, 0, 'L', 0);								
	$pdf->Ln(5);
	$pdf->Cell(15, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(5, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(20, 5, 'Jabatan Lama ', 0, 0, 'L', 0);
	$pdf->Cell(5, 5, ':', 0, 0, 'L', 0);	
	$pdf->Cell(100, 5, $xPosisiLama, 0, 0, 'L', 0);										
	$pdf->Ln(5);
	$pdf->Cell(15, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(5, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(20, 5, 'MENJADI', 0, 0, 'L', 0);
	$pdf->Cell(5, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(100, 5, '', 0, 0, 'L', 0);							
	$pdf->Ln(5);
	$pdf->Cell(15, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(5, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(20, 5, 'Jabatan Baru ', 0, 0, 'L', 0);
	$pdf->Cell(5, 5, ':', 0, 0, 'L', 0);	
	$pdf->Cell(100, 5, $xPosisi, 0, 0, 'L', 0);				
	$pdf->Ln(8);
	$pdf->Cell(15, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(5, 5, '2.', 0, 0, 'L', 0);	
	$pdf->Cell(130, 5, 'Masa percobaan atau evaluasi jabatan baru ini adalah selama 3 bulan dan berlaku efektif mulai ' . $xTglEfektif, 0, 0, 'L', 0);
	$pdf->Ln(5);
	$pdf->Cell(15, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(5, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(130, 5, 'sampai dengan surat keputusan yang baru berdasarkan pertimbangan Pimpinan Perusahaan PT. Merak Jaya Beton', 0, 0, 'L', 0);					
	$pdf->Ln(8);
	$pdf->Cell(15, 5, '', 0, 0, 'L', 0);	
	...
	$pdf->Cell(15, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(5, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(130, 5, 'Dengan adanya surat keputusan ini yang bersangkutan harus segera menjalankan tugas dan tanggung jawabnya ', 0, 0, 'L', 0);							
	$pdf->Ln(5);
	$pdf->Cell(15, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(5, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(130, 5, 'sesuai dengan tanggal penetapan surat keputusan ini.', 0, 0, 'L', 0);						
	$pdf->Ln(8);
	$pdf->Cell(15, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(35, 5, 'Demikian Surat Promosi ini dibuat untuk dilaksanakan dengan penuh tanggung jawab.', 0, 0, 'L', 0);
	$pdf->Ln(13);
	...
	$pdf->SetFont('Arial', '', 6);
	$pdf->Cell(15, 10, '', 0, 0, 'L', 0);	
	$pdf->Cell(35, 10, 'Tembusan :', 0, 0, 'L', 0);						
	$pdf->Ln(5);
	$pdf->Cell(15, 10, '', 0, 0, 'L', 0);	
	$pdf->Cell(35, 10, '-  Direktur PT. Merak Jaya Beton', 0, 0, 'L', 0);					
	$pdf->Ln(5);
	$pdf->Cell(15, 10, '', 0, 0, 'L', 0);	
	$pdf->Cell(35, 10, '-  Manager Area', 0, 0, 'L', 0);					
	$pdf->Ln(5);
	$pdf->Cell(15, 10, '', 0, 0, 'L', 0);	
	$pdf->Cell(35, 10, '-  Yang Bersangkutan', 0, 0, 'L', 0);						
	$pdf->Ln(5);
	$pdf->Cell(15, 10, '', 0, 0, 'L', 0);	
	$pdf->Cell(35, 10, '-  Arsip', 0, 0, 'L', 0);					
