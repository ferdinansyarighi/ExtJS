...
$managerHRD = $rowHRD[0];
	...
	$pdf->Cell(130, 5, 'Pentingnya personil yang capabel di Area Plan ' . $xLokasi, 0, 0, 'L', 0);						
	$pdf->Ln(5);
	$pdf->Cell(20, 5, '', 0, 0, 'L', 0);	
	...
	$pdf->Cell(20, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(5, 5, '1.', 0, 0, 'L', 0);	
	$pdf->Cell(130, 5, 'Peraturan Perusahaan di lingkungan Plan ' . $xLokasi, 0, 0, 'L', 0);						
	$pdf->Ln(5);
	$pdf->Cell(20, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(5, 5, '2.', 0, 0, 'L', 0);	
	$pdf->Cell(130, 5, 'Kelancaran  operasional di Area Plan ' . $xLokasi, 0, 0, 'L', 0);								
	$pdf->Ln(8);
	$pdf->Cell(15, 5, '', 0, 0, 'L', 0);	
	...
	$pdf->Cell(20, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(5, 5, '1.', 0, 0, 'L', 0);	
	$pdf->Cell(130, 5, 'Mendemosikan ' . $xKaryawan . ' sebagai ' . $xPosisiLama . ' Plan ' . $xLokasiLama . ' menjadi ', 0, 0, 'L', 0);						
	$pdf->Ln(5);
	$pdf->Cell(20, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(5, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(130, 5, $xPosisi . ' Plan ' . $xLokasi . ', bertanggung jawab kepada atasan langsung ' . $managerDept , 0, 0, 'L', 0);						
	$pdf->Ln(5);
	$pdf->Cell(20, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(5, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(130, 5, 'sebagai Manager Area Saudara.', 0, 0, 'L', 0);								
	$pdf->Ln(5);
	$pdf->Cell(20, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(5, 5, '2.', 0, 0, 'L', 0);	
	...
	$pdf->Cell(130, 5, 'Surat Demosi ini berlaku effktif mulai ' . $xTglEfektif, 0, 0, 'L', 0);								
	$pdf->Ln(8);
	$pdf->Cell(15, 5, '', 0, 0, 'L', 0);	
	$pdf->Cell(35, 5, 'Demikian Surat Demosi ini dibuat untuk dilaksanakan dengan penuh tanggung jawab.', 0, 0, 'L', 0);
	$pdf->Ln(13);
