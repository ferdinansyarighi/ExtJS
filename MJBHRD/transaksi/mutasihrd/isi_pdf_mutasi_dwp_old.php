...
$managerHRD = $rowHRD[0];	
	...
	$pdf->Cell(60, 4, '[    ]  Tetap                       [    ]  Percobaan', 0, 0, 'L', 0);
	$pdf->Cell(30, 4, '[    ]  PJS', 0, 0, 'L', 0);
	$pdf->Cell(60, 4, '[    ]  Kontrak                     [    ]  Kontrak Khusus', 'R', 0, 'L', 0);
	$pdf->Ln(4);
	$pdf->Cell(8, 4, '', 0, 0, 'L', 0);	
	$pdf->Cell(30, 4, 'Sifat Perubahan *) :', 'L', 0, 'L', 0);
	$pdf->Cell(60, 4, '[    ]  Tetap                       [    ]  Sementara  ...................', 0, 0, 'L', 0);
	...
	$pdf->Cell(60, 6, 'Rp. '.$gaji_lama, 1, 0, 'L', 0);
	$pdf->Cell(60, 6, 'Rp. '.$gaji_baru, 1, 0, 'L', 0);
	$pdf->Ln(6);
	$pdf->Cell(8, 6, '', 0, 0, 'L', 0);	
