...
$org_name = "";
 if(isset($_SESSION[APP]['user_id']))
  ...
  {
	$id = $_GET['id_temp'];
	$querywhere .= " AND TRANSAKSI_ID = $id";  
  }
...
//$hdid=$_GET['hd_id']; 
	...
	//$result = oci_parse($con, "SELECT ID AS HD_ID , FILENAME AS DATA_FILE FROM MJ.MJ_TEMP_UPLOAD WHERE TRANSAKSI_KODE='BONMGRHRD' $querywhere");
	oci_execute($result);
	while($row = oci_fetch_row($result))
	{
		...
		WHERE APP_ID=" . APPCODE . " AND id=$TransID AND TRANSAKSI_KODE = 'BONMGRHRD'";
		//echo $queryAtt;exit;
