...
$queryLogin = "SELECT CASE WHEN PJ.name like '%FIN%' THEN '6'
	...
	if($tingkat == 6){
		$query = "SELECT BS.ID, BS.NO_BS, BS.ASSIGNMENT_ID, PPF.FULL_NAME PEMOHON, BS.PENANGGUNG_JAWAB, PPF2.FULL_NAME PJ, BS.NOMINAL
			, BS.KETERANGAN, BS.AKTIF, 0, PPF.PERSON_ID, BS.TIPE, BS.TIPE_PENCAIRAN, BS.NO_REK, BS.TGL_PENCAIRAN,  BS.STATUS
			FROM MJ.MJ_T_BS BS
			...
			WHERE 1=1 AND BS.TINGKAT = 6 AND BS.STATUS = 'Validated' and BS.TGL_PENCAIRAN IS NOT NULL
			 $queryfilter
			ORDER BY BS.ID
			";
	}
