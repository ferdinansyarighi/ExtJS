<?PHP
	...
	include 'D:/dataSource/MJBHRD/transaksi/importplant/fungsiTimecardxo_RRU.php';
			...
			if($cekShift >= 1)
			{
				...
				$JamHitungBesok = '';
					...
					if($cekShift >= 1)
					{
						...
						// menambah filter jam RRU -> cari shift dulu, hitung early in/out late in/out baru select sql server
							$querybes = "SELECT CIO.KaryaCode, CIO.TranDate, CIO.StateCode
							FROM CardInOut CIO 
							WHERE CONVERT(VARCHAR(10), CIO.TranDate,120)=CONVERT(VARCHAR(10),DATEADD(day, - $pengurangan, getdate()),120)
							AND CIO.KaryaCode=$dataId ";
						echo "<br>Q1=>".$querybes."<br>";
						//exit();
				...
				*/
					...
					echo "keluar=>".$Keluar."<=masuk=>".$Masuk."=>shift<=".$ShiftId."<br>";
					...
					echo "<br><br>TGL: ".$Tgl."<=Tgl Besok:=>".$TglBesok."<br><br>";
									$resultDateOut = oci_parse($con,$queryDateOut);
									oci_execute($resultDateOut);
									$rowDateOut = oci_fetch_row($resultDateOut);
									$dateout = $rowDateOut[0];
					...
					echo "<br><br>dateout=>".$dateout."<=Jam=>".$Jam."<=JamHitung=>".$JamHitung."<br><br>";
					echo "JamBesok=>".$JamBesok."<=JamHitungBesok=>".$JamHitungBesok."<br><br>";
					echo "early_in=>".$early_in."<=late_in=>".$late_in."<br><br>";
					...
					echo "<br><br>early_out=>".$early_out."<=late_out=>".$late_out."<=countbro=>".$countbro."<==<br><br>";
									...
									echo "<br><br>Jam Masuk =>".$JamMasuk."JamMasukAsli =>".$JamMasukAsli."<br><br>";
									echo "<br><br>JamKeluar =>".$JamKeluar."JamKeluarAsli =>".$JamKeluarAsli."<br><br>";
									
								}
								
								echo "<br><br>";
					echo "data id =>".trim($dataId)."-"."Tgl Header =>".$TglHeader."-"."Jam Masuk =>".$JamMasuk."-"."Jam Masuk Hitung =>".$JamMasukHitung."-"."Jam Keluar =>".$JamKeluar."-"."Jam Keluar Hitung =>".$JamKeluarHitung." ";
						echo "dateout : ".$dateout;
						echo "<br><br>";
