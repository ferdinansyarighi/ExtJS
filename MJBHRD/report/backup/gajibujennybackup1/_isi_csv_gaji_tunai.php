...
{	
	...
	//echo $bulan . " dan " . $bulanBesok;
	$periode = '2016' . $bulanBesok . '02';
}


 $namaFile ="Report_Gaji_Tunai_" . $bulan ."_" . $tahun . ".csv";
...
WHERE   PAF.PERSON_ID=PPF.PERSON_ID
        ...
        AND TRIM(REGEXP_SUBSTR(PPF.PREVIOUS_LAST_NAME, '[^-]+', 1, 2)) IS NULL
	...
	while($row = oci_fetch_row($resultGaji))
	{
		...
		$recordDetail = array($noRekening, $fullName, $rekening, '', '', 'IDR', $totalGaji, '', '', 'IBU', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'extended payment detail1');
