...
{	
	...
	$dept = $_GET['dept'];
	if($perusahaan!=''){
		$queryfilter .= " AND E.NAME='$perusahaan'";
	}
	if($nama!=''){
...
LEFT JOIN APPS.HR_ORGANIZATION_UNITS E ON A.ORGANIZATION_ID=E.ORGANIZATION_ID
...
WHERE P.EFFECTIVE_END_DATE > SYSDATE AND A.EFFECTIVE_END_DATE > SYSDATE
