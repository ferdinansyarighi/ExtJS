...
<tr>
    <td colspan=\"13\"><div align=\"center\">Report Gaji Minus</div></td>
</tr>
<tr>
    ...
    <td><div align=\"center\">Total Gaji Seharusnya</div></td>
    <td><div align=\"center\">Total Gaji Minus</div></td>
 ...
 ";
	...
	$queryHeader = "SELECT  DISTINCT 
        ...
        ,(GP.GAJI_POKOK + CAST(NVL(UTJ.UANG_TUNJAB, 0) AS DECIMAL)
        ...
        + CAST(NVL(UTG.UANG_TUNGRADE, 0) AS DECIMAL)
        + (CAST(NVL(URG.UANG_REVGAJ, 0) AS DECIMAL))) AS GAJI_SEHARUSNYA
        ...
        + (CAST(NVL(URG.UANG_REVGAJ, 0) AS DECIMAL)) + GP.GAJI_POKOK AS TOTAL_GAJI
...
WHERE   PAF.PERSON_ID=PPF.PERSON_ID
	...
	while($row = oci_fetch_row($resultHeader))
	{
		...
		<tr>
			...
			<td><div align=\"left\">$totGajiSeharusnya</div></td>
			<td><div align=\"left\">$totGaji</div></td>
