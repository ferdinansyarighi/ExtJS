...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A1', 'Report Perhitungan Gaji Karyawan Plant')
            ...
            ->setCellValue('E4', 'Departemen')
            ->setCellValue('F4', 'Jabatan')
            ->setCellValue('G4', 'Lokasi / Plant')
            ->setCellValue('H4', 'Hari Masuk')
            ->setCellValue('I4', 'Gaji Harian')
            ->setCellValue('J4', 'Hari Sakit')
            ->setCellValue('K4', 'Hari Cuti')
            ->setCellValue('L4', 'Hari Ijin')
            ->setCellValue('M4', 'Hari Alpha')
            ->setCellValue('N4', 'Terlambat 1')
            ->setCellValue('O4', 'Terlambat 2')
            ->setCellValue('P4', 'Terlambat 3')
            ->setCellValue('Q4', 'Terlambat 4')
            ->setCellValue('R4', 'Total Gaji Harian')
            ->setCellValue('S4', 'Gaji Mingguan')
            ->setCellValue('T4', 'Uang Makan')
            ->setCellValue('U4', 'Lembur')
            ->setCellValue('V4', 'Premi')
            ->setCellValue('W4', 'Tunj Hari Libur')
            ->setCellValue('X4', 'Tunj Hari Kerja')
            ->setCellValue('Y4', 'Tunj Tidak Istirahat')
            ->setCellValue('Z4', 'Tunj Masuk Awal')
            ->setCellValue('AA4', 'Tunj Jabatan')
            ->setCellValue('AB4', 'BPJS Kesehatan')
            ->setCellValue('AC4', 'BPJS TK')
            ->setCellValue('AD4', 'Pinjaman')
            ->setCellValue('AE4', 'BS')
            ->setCellValue('AF4', 'Absen')
            ->setCellValue('AG4', 'Telat')
            ->setCellValue('AH4', 'Total Gaji')
            ->setCellValue('AI4', 'Revisi Gaji')
            ->setCellValue('AJ4', 'Total diTransfer')
            ->setCellValue('AK4', 'Transfer Tunai');
...
, REGEXP_SUBSTR(pj.name, '[^.]+', 1, 2) as dept, REGEXP_SUBSTR(pps.name, '[^.]+', 1, 3) as jabatan, PG.name
...
while($row = oci_fetch_row($resultPerson)){
	...
	while($rowGaji = oci_fetch_row($resultGaji)){
		...
		switch($element){
			...
			case 'E_LEMBUR':
				...
				$totalUangLembur = 0;
				$queryJamLembur = "SELECT MTSD.TOTAL_JAM, NVL(MTT.JAM_MASUK, '16:00'), NVL(REPLACE(MTT.JAM_KELUAR, '24:', '00:'), NVL(MTSI.JAM_TO, NVL(REPLACE(MTT2.JAM_KELUAR, '24:', '00:'), '23:59'))), MTS.TANGGAL_SPL        
			...
			case 'E_BPJS_KESEHATAN':
				...
				//Request mbak Isa per tgl 14-Nov-2018
				//if($cekTgl1 == 1){
				...
				//}
				$querypid = "SELECT COUNT(1) JML_BPJS_KS 
	...
	$objPHPExcel->setActiveSheetIndex(0)
				...
				->setCellValue('I' . $xlsRow, $eGajiHarian)
				->setCellValue('J' . $xlsRow, $vHariSakit)
				->setCellValue('K' . $xlsRow, $vHariCuti)
				->setCellValue('L' . $xlsRow, $vHariIjin)
				->setCellValue('M' . $xlsRow, $vHariAlpha)
				->setCellValue('N' . $xlsRow, $vTerlambat1)
				->setCellValue('O' . $xlsRow, $vTerlambat2)
				->setCellValue('P' . $xlsRow, $vTerlambat3)
				->setCellValue('Q' . $xlsRow, $vTerlambat4)
				->setCellValue('R' . $xlsRow, $gajiHarian)
				->setCellValue('S' . $xlsRow, $gajiMingguan)
				->setCellValue('T' . $xlsRow, $uangMakan)
				->setCellValue('U' . $xlsRow, $totalUangLembur)
				->setCellValue('V' . $xlsRow, $premi)
				->setCellValue('W' . $xlsRow, $tunHariLibur)
				->setCellValue('X' . $xlsRow, $tunHariKerja)
				->setCellValue('Y' . $xlsRow, $tunTidakIstirahat)
				->setCellValue('Z' . $xlsRow, $tunMasukAwal)
				->setCellValue('AA' . $xlsRow, $tunJabatan)
				->setCellValue('AB' . $xlsRow, $BPJSKS)
				->setCellValue('AC' . $xlsRow, $BPJSTK)
				->setCellValue('AD' . $xlsRow, $vPotongan)
				->setCellValue('AE' . $xlsRow, $vBS)
				->setCellValue('AF' . $xlsRow, $absen)
				->setCellValue('AG' . $xlsRow, $telat)
				->setCellValue('AH' . $xlsRow, $vTotGajiSkr)
				->setCellValue('AI' . $xlsRow, $revisi)
				->setCellValue('AJ' . $xlsRow, $vTotGajiTransfer)
				->setCellValue('AK' . $xlsRow, $vTransTunai);
}
