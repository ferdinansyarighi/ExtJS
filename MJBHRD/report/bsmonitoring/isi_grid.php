...
$query = "SELECT DISTINCT BS.ID, BS.NO_BS, PPF.FULL_NAME PEMOHON, HOU.NAME PERUSAHAAN
...
while($row = oci_fetch_row($result))
{
	...
	$record['DATA_TANGGAL_PENCAIRAN']=$row[18];
	$record['DATA_TANGGAL_CLOSE']=$row[19];
	$record['DATA_NOMINAL_OUTSTANDING']='Rp '.number_format($row[20], 2, ',', '.');
	$record['DATA_TANGGAL_JT']=$row[21];
	$record['DATA_PERUSAHAAN_BS']=$row[22];
