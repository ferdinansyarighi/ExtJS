...
{	
 ...
 $namaFile ="Report_Gaji_" . $bulan ."_" . $tahun . ".xls";
...
<tr>
    <td><div>P</div></td>
	<td><div>$periode</div></td>
    <td><div>$rekening</div></td>
 ";
...
$isiKaryawan = ""; 
	...
	while($row = oci_fetch_row($resultGaji))
	{
		...
		$isiKaryawan .= "<tr>
			<td><div>$noRekening</div></td>
			<td><div>$atasNama</div></td>
			<td><div>$rekening</div></td>
			<td><div></div></td>
			<td><div></div></td>
			<td><div>IDR</div></td>
			<td><div>$totalGaji</div></td>
			<td><div></div></td>
			<td><div></div></td>
			<td><div>IBU</div></td>
			<td><div></div></td>
			...
			<td><div></div></td>
			<td><div></div></td>
			<td><div>extended payment detail1</div></td>
		</tr>"; 
	}
	
	$isiExcel .= "
    <td><div>$countData</div></td>
	<td><div>$sumGaji</div></td>
</tr>
 ";
 
$isiExcel .= $isiKaryawan;
