...
, MTP.TINGKAT
, MTP.NOMINAL * MTP.JUMLAH_CICILAN_AWAL OUTSTANDINGRP
...
while($row = oci_fetch_row($result))
{
	...
	$record['DATA_OUTSTANDINGRP']=$row[22];
	$record['DATA_OUTSTANDINGBLN']=$row[23];
	$record['DATA_POTONGAN_AKHIR']=$row[24];
	$record['DATA_TGL_PENCAIRAN']=$row[25];
