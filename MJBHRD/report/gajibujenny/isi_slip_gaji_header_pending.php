...
$countHeader = 0;
	...
	AND hl.location_code = decode('".$plant."', 'null', hl.location_code, '".$plant."') 
...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('Q' . $xlsRow, 'Gaji Pokok')
            ->setCellValue('R' . $xlsRow, 'Tunjangan Jabatan')
            ->setCellValue('S' . $xlsRow, 'Tunjangan Lokasi')
            ->setCellValue('T' . $xlsRow, 'Tunjangan Grade')
            ->setCellValue('U' . $xlsRow, 'Uang Makan')
            ->setCellValue('V' . $xlsRow, 'Uang Transport')
            ->setCellValue('W' . $xlsRow, 'Premi Hadir')
            ->setCellValue('X' . $xlsRow, 'Lembur')
            ->setCellValue('Y' . $xlsRow, 'PPH21')
            ->setCellValue('Z' . $xlsRow, 'BPJS Kesehatan')
            ->setCellValue('AA' . $xlsRow, 'BPJS TK')
            ->setCellValue('AB' . $xlsRow, 'Pinjaman')
            ->setCellValue('AC' . $xlsRow, 'BS')
            ->setCellValue('AD' . $xlsRow, 'Absen')
            ->setCellValue('AE' . $xlsRow, 'Telat')
            ->setCellValue('AF' . $xlsRow, 'Total Gaji')
            ->setCellValue('AG' . $xlsRow, 'Revisi Gaji Bulan Lalu')
            ->setCellValue('AH' . $xlsRow, 'Pending Gaji')
		...
		$objPHPExcel->setActiveSheetIndex(0)
					...
					->setCellValue('AH' . $xlsRow, $vPending)
