...
LEFT JOIN MJ_T_SIK MTS ON MTS.PERSON_ID=PPF.PERSON_ID AND MTT.TANGGAL BETWEEN MTS.TANGGAL_FROM AND MTS.TANGGAL_TO
LEFT JOIN MJ_T_SPL_DETAIL MTSPD ON MTSPD.NAMA=PPF.FULL_NAME
