...
AND PAF.GRADE_ID = PG.GRADE_ID AND PG.NAME LIKE '%Manager%' AND PPF.FULL_NAME LIKE '%$empname%'";
...
else if ($jumman >=1)
{
	...
	$query = "SELECT '---Anda Bukan Manager---' AS DATA_VALUE, '---Anda Bukan Manager---' AS DATA_NAME FROM DUAL";
}
